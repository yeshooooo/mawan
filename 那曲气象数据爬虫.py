...
def main():
    ...
    for latitude in np.arange(29, 37, 0.5):
        for longitude in np.arange(83, 83, 0.5):
            ...
            dataexcel.to_excel(r'C:\Users\DELL\Desktop\那曲气象数据\NASA天气文件lat={},lon={}.xlsx'.format(latitude, longitude),
